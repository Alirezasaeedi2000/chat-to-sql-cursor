...
class VectorStoreManager:
    ...
    def __init__(
        ...
        # Column mapping fallback for schema mismatches (UPDATED to match actual database schema)
        self.column_mappings = {
            ...
            'packaging_info': {
                ...
                'tranWeight': 'tranWeight',
                'templeCount': 'templeCount',
                'templeWeight': 'templeWeight',
                'sample': 'sample',
                'bakeID': 'bakeID',
                'refer': 'refer',
                'referTemple': 'referTemple',
            },
            'person_hyg': {
                'per_hy_id': 'per_hy_id',
                'ind': 'ind',
            ...
            'prices': {
                ...
                'cream': 'cream',
                'oil': 'oil',
                'wheatStarch': 'wheatStarch',
                'citrate': 'citrate',
                'phosphate': 'phosphate',
                'stablizer': 'stablizer',
                'salt': 'salt',
                'butterEssential': 'butterEssential',
                'powderEssential': 'powderEssential',
                'water': 'water',
                'vegetableButter': 'vegetableButter',
                'dryMilk': 'dryMilk',
                'mpc': 'mpc',
                'namaisin': 'namaisin',
                'sorbet': 'sorbet',
                'lastEdit': 'lastEdit',
                'lastEdittor': 'lastEdittor',
                'id': 'id',
                'w1000': 'w1000',
                'w2000': 'w2000',
                'w3000': 'w3000',
            ...
            'production_info': {
                ...
                'tranNumber': 'tranNumber',
                'tranWeight': 'tranWeight',
                'tran2Number': 'tran2Number',
                'tran2Weight': 'tran2Weight',
                'templeCount': 'templeCount',
                'tranProdWeight': 'tranProdWeight',
                ...
                'QCoil': 'QCoil',
                'cst': 'cst',
                'meltability': 'meltability',
                'drymatter': 'drymatter',
                'meltTime': 'meltTime',
                'QCDesc': 'QCDesc',
                'bakeStartTime': 'bakeStartTime',
                'bakeEndTime': 'bakeEndTime',
                'nc1Type': 'nc1Type',
                'nc1Amount': 'nc1Amount',
                'nc2Type': 'nc2Type',
                'nc2Amount': 'nc2Amount',
                ...
                'nc6Amount': 'nc6Amount',
                'NCSum': 'NCSum',
                'totalMaterUsage': 'totalMaterUsage',
            },
            'production_test': {
                'bakeID': 'bakeID',
                'date': 'date',
            ...
            'repo_nc': {
                ...
                'total': 'total',
                'usage': 'usage',
                'templeCheese': 'templeCheese',
                'repoprodWeight': 'repoprodWeight',
            },
            'transtatus': {
                'tranNumber': 'tranNumber',
